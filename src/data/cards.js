...
export const ABILITY_TEXT = {
  ...
  icebeamdance: '오로라빔(스이쿤 전용기): 나올 때 상대 전체 얼음 피해 2 + 1마리에게 얼음 상태이상',
  skydive: '불사르기(파이어 전용기): 나올 때 불꽃 피해 3을 무작위로 3회 입힌다',
  burningfall: '분화(엔테이 전용기): 나올 때 적 전체 불꽃 피해 3. 쾌청이면 피해 +2',
  thunderwave: '천둥차기(썬더 전용기): 나올 때 적 전체 전기 피해 3. 무작위 1마리에게 마비 상태이상',
  thunderfang: '와일드볼트(라이코 전용기): 나올 때 무작위 상대에게 전기 피해 4 + 마비 상태이상',
  precipiceblades: '단애의칼(그란돈 전용기): 나올 때 쾌청 발동. 상대 전체 땅 피해 4',
  frostedgale: '얼어붙는시선(프리져 전용기): 나올 때 상대 전체 얼음 피해 2 + 전부 얼음 상태이상',
  icelock: '눈보라(레지아이스 전용기): 나올 때 상대 전체에게 얼음 상태이상 + 얼음 피해 1',
  ...
  moldbreaker: '틀깨기: 나올 때 상대 도발 포켓몬 하나를 골라 도발을 없애고 벌레 타입 피해 2를 입힌다',
  ...
  blizzard: '눈보라: 나왔을 때 상대 전체에게 얼음 타입 피해 1, 무작위 하나에게 얼음 상태이상',
...
export const CARDS = [
  ...
  P('gyarados', '갸라도스', '물', 6, 9, 6, 'E', { stage: 1, evolvesFrom: 'magikarp', ability: 'intimidate' }),
  ...
  P('sunflora', '해루미나', '풀', 3, 5, 4, 'R', { stage: 1, evolvesFrom: 'sunkern', ability: 'chlorophyll' }),
  ...
  P('dugtrio', '닥트리오', '땅', 3, 6, 3, 'R', { stage: 1, evolvesFrom: 'diglett', ability: 'skilllink' }),
  P('sandslash', '고지', '땅', 3, 3, 5, 'C', {}),
  P('rhyhorn', '뿔카노', '땅', 1, 1, 1, 'C', {}),
  P('rhydon', '코뿌리', '땅', 4, 2, 8, 'R', { stage: 1, evolvesFrom: 'rhyhorn', ability: 'taunt' }),
  P('rhyperior', '거대코뿌리', '땅', 7, 9, 11, 'E', { stage: 2, evolvesFrom: 'rhydon' }),
  ...
  P('pidgeotto', '피죤', '비행', 2, 3, 4, 'C', { stage: 1, evolvesFrom: 'pidgey' }),
  P('pidgeot', '피죤투', '비행', 4, 7, 6, 'R', { stage: 2, evolvesFrom: 'pidgeotto', ability: 'keeneye' }),
  ...
  P('raticate', '레트라', '노말', 2, 5, 3, 'C', { stage: 1, evolvesFrom: 'rattata' }),
  ...
  P('butterfree', '버터플', '벌레', 3, 4, 5, 'R', { stage: 1, evolvesFrom: 'caterpie', ability: 'sleeppowder' }),
  ...
  P('beedrill', '독침붕', '벌레', 4, 8, 5, 'R', { stage: 2, evolvesFrom: 'kakuna', ability: 'guts' }),
  P('heracross', '헤라크로스', '벌레', 4, 5, 4, 'R', { ability: 'moxie' }),
  P('pinsir', '쁘사이저', '벌레', 4, 5, 4, 'R', { ability: 'moldbreaker' }),
  P('ledyba', '레디바', '벌레', 1, 1, 2, 'C', {}),
  P('ledian', '레디안', '벌레', 3, 3, 6, 'R', { stage: 1, evolvesFrom: 'ledyba', ability: 'skilllink' }),
  ...
  P('lucario', '루카리오', '격투', 5, 6, 7, 'E', { stage: 1, evolvesFrom: 'riolu', ability: 'aura_fighting' }),
  ...
  P('nidorino', '니드리노', '독', 2, 4, 3, 'C', { stage: 1, evolvesFrom: 'nidoranm' }),
  P('nidoking', '니드킹', '독', 5, 8, 7, 'E', { stage: 2, evolvesFrom: 'nidorino', ability: 'earthpower' }),
  P('nidoranf', '니드런♀', '독', 1, 1, 1, 'C', {}),
  P('nidorina', '니드리나', '독', 2, 3, 4, 'C', { stage: 1, evolvesFrom: 'nidoranf' }),
  ...
  P('kirlia', '킬리아', '에스퍼', 2, 2, 4, 'C', { stage: 1, evolvesFrom: 'ralts', ability: 'teleport' }),
  P('gardevoir', '가디안', '에스퍼', 5, 8, 7, 'E', { stage: 2, evolvesFrom: 'kirlia', ability: 'moonlight' }),
  ...
  P('pupitar', '데기라스', '바위', 3, 3, 5, 'R', { stage: 1, evolvesFrom: 'larvitar', ability: 'sturdy', flavor: '드디어 합류했다. 오래 기다렸지.' }),
  P('tyranitar', '마기라스', '바위', 6, 9, 8, 'E', { stage: 2, evolvesFrom: 'pupitar', ability: 'sandstream' }),
  P('geodude', '꼬마돌', '바위', 1, 0, 1, 'C', { ability: 'sturdy' }),
  P('graveler', '데구리', '바위', 3, 3, 5, 'R', { stage: 1, evolvesFrom: 'geodude', ability: 'sturdy' }),
  ...
  P('haunter', '고우스트', '고스트', 3, 5, 3, 'R', { stage: 1, evolvesFrom: 'gastly', ability: 'levitate' }),
  P('gengar', '팬텀', '고스트', 5, 8, 7, 'E', { stage: 2, evolvesFrom: 'haunter', ability: 'hypnosis' }),
  P('misdreavus', '무우마', '고스트', 2, 2, 3, 'C', { ability: 'levitate' }),
  P('mimikyu', '따라큐', '고스트', 3, 3, 4, 'R', { ability: 'disguise' }),

  // ============ 드래곤 (11) ============
  P('dratini', '미뇽', '드래곤', 1, 1, 1, 'C', {}),
  P('dragonair', '신뇽', '드래곤', 3, 4, 5, 'R', { stage: 1, evolvesFrom: 'dratini' }),
  P('dragonite', '망나뇽', '드래곤', 6, 9, 8, 'E', { stage: 2, evolvesFrom: 'dragonair', ability: 'multiscale' }),
  P('kingdra', '킹드라', '드래곤', 5, 8, 7, 'E', { stage: 2, evolvesFrom: 'seadra', ability: 'swiftswim' }),
  P('swablu', '파비코', '드래곤', 1, 1, 2, 'C', {}),
  P('altaria', '파비코리', '드래곤', 4, 4, 7, 'R', { stage: 1, evolvesFrom: 'swablu', ability: 'regenerator' }),
  ...
  P('bisharp', '절각참', '악', 3, 5, 4, 'R', { stage: 1, evolvesFrom: 'pawniard' }),
  P('kingambit', '대도각참', '악', 6, 8, 9, 'E', { stage: 2, evolvesFrom: 'bisharp', ability: 'supremeoverlord' }),
  ...
  P('clefable', '픽시', '페어리', 4, 4, 7, 'R', { stage: 1, evolvesFrom: 'clefairy', ability: 'moonlight' }),
  P('marill', '마릴', '페어리', 1, 1, 1, 'C', { ability: 'thickfat' }),
  P('azumarill', '마릴리', '페어리', 3, 4, 5, 'R', { stage: 1, evolvesFrom: 'marill', ability: 'thickfat' }),
  P('jigglypuff', '푸린', '페어리', 2, 1, 3, 'C', { ability: 'sing' }),
  P('wigglytuff', '푸크린', '페어리', 4, 4, 7, 'R', { stage: 1, evolvesFrom: 'jigglypuff', ability: 'sing' }),
  P('togepi', '토게피', '페어리', 1, 0, 2, 'C', { ability: 'healer' }),
  P('togetic', '토게틱', '페어리', 3, 3, 6, 'R', { stage: 1, evolvesFrom: 'togepi', ability: 'healer' }),
  P('granbull', '그랑블루', '페어리', 4, 5, 4, 'R', { ability: 'intimidate' }),
  P('sylveon', '님피아', '페어리', 3, 3, 6, 'R', { stage: 1, evolvesFrom: 'eevee', ability: 'moonlight' }),

  // ============ v5 신규 포켓몬 (타입 보강) ============
  // 고스트
  P('duskull', '해골몽', '고스트', 1, 1, 1, 'C', {}),
  P('dusclops', '미라몽', '고스트', 3, 3, 6, 'R', { stage: 1, evolvesFrom: 'duskull' }),
  P('dusknoir', '야느와르몽', '고스트', 5, 7, 8, 'E', { stage: 2, evolvesFrom: 'dusclops', ability: 'levitate' }),
  P('rotom', '로토무', '전기', 3, 3, 4, 'R', { ability: 'voltabsorb' }),
  // 비행
  P('hoothoot', '부우부', '비행', 1, 1, 2, 'C', {}),
  P('noctowl', '야부엉', '비행', 3, 4, 5, 'R', { stage: 1, evolvesFrom: 'hoothoot', ability: 'keeneye' }),
  P('wingull', '갈모매', '비행', 1, 1, 2, 'C', {}),
  P('pelipper', '패리퍼', '비행', 3, 3, 6, 'R', { stage: 1, evolvesFrom: 'wingull', ability: 'drizzle' }),
  P('taillow', '테일로', '비행', 1, 1, 1, 'C', { ability: 'rush' }),
  P('swellow', '스왈로', '비행', 3, 5, 4, 'R', { stage: 1, evolvesFrom: 'taillow', ability: 'rush' }),
  P('hoppip', '통통코', '비행', 1, 1, 1, 'C', {}),
  P('skiploom', '두코', '비행', 2, 2, 5, 'C', { stage: 1, evolvesFrom: 'hoppip' }),
  P('jumpluff', '솜솜코', '비행', 4, 5, 8, 'R', { stage: 2, evolvesFrom: 'skiploom', ability: 'sleeppowder' }),
  ...
  P('bronzong', '동탁군', '강철', 4, 4, 7, 'R', { stage: 1, evolvesFrom: 'bronzor', ability: 'levitate' }),
  // 땅
  P('numel', '둔타', '땅', 1, 1, 2, 'C', {}),
  P('camerupt', '폭타', '땅', 3, 4, 6, 'R', { stage: 1, evolvesFrom: 'numel' }),
  P('phanpy', '코코리', '땅', 1, 2, 1, 'C', {}),
  P('donphan', '코리갑', '땅', 3, 5, 4, 'R', { stage: 1, evolvesFrom: 'phanpy', ability: 'rush' }),
  P('wooper', '우파', '땅', 1, 1, 2, 'C', {}),
  P('quagsire', '누오', '땅', 3, 4, 5, 'R', { stage: 1, evolvesFrom: 'wooper', ability: 'waterabsorb' }),
  // 노말
  P('sentret', '꼬리선', '노말', 1, 1, 2, 'C', {}),
  P('furret', '다꼬리', '노말', 2, 4, 3, 'C', { stage: 1, evolvesFrom: 'sentret', ability: 'rush' }),
  P('teddiursa', '깜지곰', '노말', 1, 2, 1, 'C', {}),
  P('ursaring', '링곰', '노말', 3, 5, 4, 'R', { stage: 1, evolvesFrom: 'teddiursa', ability: 'guts' }),
  P('bidoof', '비버니', '노말', 1, 1, 2, 'C', {}),
  P('bibarel', '비버통', '노말', 2, 5, 3, 'C', { stage: 1, evolvesFrom: 'bidoof' }),
  // 풀
  ...
  P('gabite', '한바이트', '드래곤', 3, 5, 4, 'R', { stage: 1, evolvesFrom: 'gible' }),
  P('garchomp', '한카리아스', '드래곤', 5, 8, 7, 'E', { stage: 2, evolvesFrom: 'gabite', ability: 'roughskin' }),
  // 전기
  P('shinx', '꼬링크', '전기', 1, 1, 1, 'C', {}),
  P('luxio', '럭시오', '전기', 3, 4, 5, 'R', { stage: 1, evolvesFrom: 'shinx' }),
  P('luxray', '렌트라', '전기', 5, 7, 8, 'E', { stage: 2, evolvesFrom: 'luxio', ability: 'intimidate' }),
  ...
  { id: 'icebeam', name: '냉동빔', kind: 'spell', type: '기술', moveType: '얼음', cost: 3, rarity: 'R', emoji: '❄️', spell: { effect: 'damage_freeze', amount: 3, target: 'enemy-any' }, text: '피해 3을 입히고, 포켓몬이라면 얼음 상태이상. (얼음 타입, 상성 적용)' },
  ...
  { id: 'gengarite', name: '팬텀나이트', kind: 'mega', type: '도구', cost: 2, rarity: 'L', emoji: '🔮', megaFor: 'gengar', mega: { atk: 2, hp: 2, ability: 'hypnosis', reBattlecry: true }, text: '팬텀 전용. +2/+2, 최면술이 다시 발동한다 - 무작위 상대에게 잠듦 상태이상. (게임당 메가진화 1회)' },
...
export const DEX = {
  ...
  diglett: 50, dugtrio: 51, sandslash: 28, rhydon: 112, rhyhorn: 111, rhyperior: 464, gligar: 207, trapinch: 328,
  ...
  nidoranf: 29, nidorina: 30, nidoqueen: 31, pinsir: 127,
  duskull: 355, dusclops: 356, dusknoir: 477, rotom: 479,
  ...
  bidoof: 399, bibarel: 400, oddish: 43, gloom: 44, vileplume: 45,
  turtwig: 387, grotle: 388, torterra: 389,
  growlithe: 58, arcanine: 59, chimchar: 390, monferno: 391, infernape: 392,
