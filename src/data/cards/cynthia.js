...
const CYNTHIA_CARDS = [
  ...
  },
  {
    ...
    text: "현재 ACTIVE 포켓몬을 체력을 유지한 채 손으로 되돌리고, 대기 중인 다른 시그니처 포켓몬과 교체한다.",
  },
];
...
Object.assign(ABILITY_TEXT, {
  cynthia_spite:
    "원한: 이 포켓몬이 ACTIVE인 동안 플레이어의 기술 카드 비용이 1 증가한다.",
  cynthia_pain_split:
    "아픔나누기: 전투당 1회, 체력이 절반 이하가 되면 플레이어 필드에서 현재 체력이 가장 높은 포켓몬과 현재 체력을 평균으로 맞춘다.",
  cynthia_toxic_spikes:
    "독압정: 처음 ACTIVE가 될 때 플레이어 진영에 독압정 2개를 설치한다. 이후 기본 포켓몬이 소환될 때 하나를 소모해 독 상태로 만든다.",
  cynthia_synthesis:
  ...
  cynthia_aqua_ring:
    "아쿠아링: 난천의 턴 종료 시 ACTIVE라면 체력을 2 회복한다.",
  cynthia_swords_dance:
    "칼춤: 처음 ACTIVE가 될 때 이미 기절한 난천의 포켓몬 수에 따라 공격력이 증가한다. 2~3마리 +1, 4마리 +2, 5마리 +3.",
  cynthia_dragon_rush:
    "드래곤다이브: 마지막 에이스로 등장하면 돌진을 얻고 첫 공격 피해 +2. 그 공격을 버틴 포켓몬은 다음 턴 공격할 수 없다.",
});
