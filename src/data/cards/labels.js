...
const TECHNIQUE_TEXT = {
  ...
  solarbeam:
    "빛의 다발을 발사하여 피해 4를 입힌다. 날씨가 맑을 때는 비용이 2 줄어든다.",
  thunderbolt:
  ...
  raindance:
    "비를 내리게 해서 물타입 기술의 위력을 올린다.",
  sunnyday:
    "햇살을 강하게 해서 불꽃타입 기술의 위력을 올린다.",
  sandstorm:
    "모래바람을 일으켜 바위, 땅, 강철타입 이외의 상대에게 데미지를 준다.",
  sheercold:
