...
function enhanceRegionCarousel(container) {
  if (!container || container.dataset.coverflowReady === "true") {
    return;
  }
  ...
  function onPointerDown(event) {
    ...
    if (event.target.closest(".region-coverflow-dots")) {
      return;
    }
...
function syncRegionCarousel() {
  ...
  if (container) {
    enhanceRegionCarousel(container);
  }
}
