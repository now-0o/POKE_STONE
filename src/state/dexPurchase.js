...
export const DEX_PURCHASE_UNLOCK_TRAINER = "unova_n";
...
export function isDexPurchaseUnlocked(save) {
  return Boolean(
    save?.adminMode ||
    (save?.wins?.[DEX_PURCHASE_UNLOCK_TRAINER] || 0) > 0,
  );
}
